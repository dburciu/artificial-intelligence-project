...
#     # Construim promptul pentru generarea descrierii
#     prompt = f"Describe the most important traits of {breed_name} cats."
...
#         pad_token_id=tokenizer.pad_token_id,
#         do_sample=True,
#         temperature=0.8,  # Crește diversitatea
#         top_p=0.9,        # Permite alegerea dintr-un subset larg de cuvinte
#         top_k=40,         # Restrânge numărul de cuvinte candidate
#         repetition_penalty=1.5,  # Penalizează repetițiile
...
#     cleaned_description = ". ".join(unique_lines)
